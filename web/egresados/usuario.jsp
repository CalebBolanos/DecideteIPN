...
<%
    ...
    String xCorreo = (String)egresado.getAttribute("correo");
    String xContrasena = (String)egresado.getAttribute("contrasena");
    int xEdad = (Integer)egresado.getAttribute("edad");
    String xGenero = (String)egresado.getAttribute("genero");
        ...
        <div id="informacion">
            ...
            <div style="color: silver; font-size: 30px;">
                ...
                <span id="ocultar" style="display: none;">
                    ...
                    <form id="formulario" action="validaCambio.jsp" onsubmit="return validar();" method="POST">
                ...
                <span id="psw" style="display: none;">
                    <form id="cambio" action="cambiarContra.jsp" onsubmit="" method="POST">
