<%-- 
    ...
    Created on : 13/05/2017, 01:35:09 PM
    Author     : Caleb
--%>
...
<html lang="es">
    ...
    <body>
        <div id="content">
            <div id="cuadro1">
                <br><br><br><br><br>Iniciar sesión<span style="font-size: 25px"><br>Como egresado</span>
            </div>
            <div id="cuadro2">
                <center><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                    <form id="iniciar" method="post" action="validarSesion.jsp" onsubmit="">
                    ...
                    <div style="">
                        <center><a href="registro.jsp"><button>¿Todavía no tienes una cuenta? registrate aquí</button></a></center>
