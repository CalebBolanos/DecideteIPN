...
<html lang="es">
    <head>
        ...
        <style>
            ...
            input[type=submit]:hover {
                background: rgba(0,0,0,0);
                color: #1B5E20;
                box-shadow: inset 0 0 0 3px #1B5E20;
            }
            .tarjeta{
    ...
    <body>
        ...
        <div style="margin: 30px; border: 5px solid #1B5E20; border-radius: 10px;" id="grande">
            ...
            <a href="http://www.cecyt5.ipn.mx/" target="blank">Visista la página de la escuela</a>
            <div id="comentarios">
                ...
                <div style="overflow: auto; margin-left: 16%">
                    <%
                        ...
                        try {
                            base.conectar();
                            ResultSet resultado = base.consulta("call spConsultaComentariosEsc(5);");
