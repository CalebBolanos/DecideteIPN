<%-- 
    ...
    Created on : 13/04/2017, 10:50:01 AM
    Author     : Caleb
--%>
...
<html lang="es">
    ...
    <body>
        <div id="content">
            <div id="cuadro1">
                <br><br><br><br><br>Registro<span style="font-size: 25px"><br>Como aspirante</span>
            </div>
            <div id="cuadro2">
                <form id="forma" action="validaRegistro.jsp" onsubmit="return validar();" method="POST"> <!--"paginaPrincipal.jsp"-->
                    </br></br><br><br>
                    <center>
