...
public class registro {
    ...
    private String _nombre, _email, _edad, _genero, _contrasena, _contrasena1;
    private String _error = "";

    public registro(String nombre, String email, String edad, String genero, String contrasena, String contrasena1) {
        this._nombre = nombre;
        this._email = email;
        this._edad = edad;
        this._genero = genero;
